...
which is automatically executed multiple times a day using **GitHub Actions**. Original project by tanjeffreyz, updated to work with current github api by rcantuv and DDFeldkamp.
